(async () => {
    ...
    let c = {
        ...
        setItem(e, t) {
            return e.split(".").reduce((e, a, o, r) => (e[a] = (e[a] ? e[a] : {}), ++o == r.length && (e[a] = t), e[a]), this.data),
                localStorage.setItem("GhstGUISettings", JSON.stringify(this.data)),
                this.data
        },
        deleteItem(e) {
    ...
    try {
        for (let d of (c.data = JSON.parse(localStorage.getItem("GHSTGUISettings") || "{}"), ["backgroundColor", "cheatList", "contentBackground", "defaultButton", "disabledButton", "enabledButton", "infoColor", "inputColor", "textColor"]))
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Ghst´s Cheats<sup>v1.0</sup></span>'
        }, l("a", {
            className: "bigButton",
            style: {
                cursor: "pointer",
